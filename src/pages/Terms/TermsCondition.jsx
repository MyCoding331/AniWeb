...
const TermsCondition = () => {
  return (
    ...
    <div className="terms-condition" >
      ...
      <p>Welcome to aniweb!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of AniWeb's Website, located at <a href="https://aniweb.fun">https://aniweb.fun.</a>
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use aniweb if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing aniweb, you agreed to use
        cookies in agreement with the AniWeb's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, AniWeb and/or its licensors own the
        intellectual property rights for all material on aniweb. All
        intellectual property rights are reserved. You may access this from
        aniweb for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from aniweb</li>
        <li>Sell, rent or sub-license material from aniweb</li>
        <li>Reproduce, duplicate or copy material from aniweb</li>
        <li>Redistribute content from aniweb</li>
      </ul>
      ...
      <p>
        ...
        AniWeb does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of AniWeb,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, AniWeb shall not be liable for the
      ...
      <p>
        AniWeb reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant AniWeb a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of AniWeb; and (d) the link is in
      ...
      <p>
        ...
        e-mail to AniWeb. Please include your name, your organization name,
      ...
      <p>
        No use of AniWeb's logo or other artwork will be allowed for linking
